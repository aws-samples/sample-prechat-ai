---
description: Planning Agent가 생성한 미팅 준비 플랜의 활용과 협업
icon: calendar-check
---

# 미팅 플랜 생성과 활용

**Planning Agent**는 BANT 요약에 이어 본 미팅을 준비할 수 있는 플랜을 자동 생성합니다. 유사 고객 사례, AWS 문서 레퍼런스, 토의 주제, 다음 행동을 제공합니다.
...
Planning Agent는 대화 중 다음 도구를 사용합니다.
